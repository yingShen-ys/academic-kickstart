...
publication: In *the Forty-Third International Conference on Machine Learning (ICML)*
...
image:
  caption: 'Comparison of the flow-matching process between standard diffusion / flow-matching models and LaTtE-Flow.'
  focal_point: ""
  preview_only: true
